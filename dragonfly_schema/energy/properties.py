...
from honeybee_schema.energy.hvac.doas import (
    FCUwithDOASAbridged,
    WSHPwithDOASAbridged,
    VRFwithDOASAbridged,
    RadiantwithDOASAbridged,
)
from honeybee_schema.energy.hvac.heatcool import (
    FCU,
    WSHP,
    VRF,
    Baseboard,
...
class Room2DEnergyPropertiesAbridged(NoExtraBaseModel):
    type: Annotated[
        str, StringConstraints(pattern="^Room2DEnergyPropertiesAbridged$")
    ...
    window_vent_opening: VentilationOpening | None = Field(
        default=None,
...
class StoryEnergyPropertiesAbridged(NoExtraBaseModel):
    type: Annotated[
        str, StringConstraints(pattern="^StoryEnergyPropertiesAbridged$")
...
class BuildingEnergyPropertiesAbridged(NoExtraBaseModel):
    type: Annotated[
        str, StringConstraints(pattern="^BuildingEnergyPropertiesAbridged$")
    ...
    ceiling_plenum_construction: str | None = Field(
        default=None,
        min_length=1,
        max_length=100,
    ...
    floor_plenum_construction: str | None = Field(
        default=None,
        min_length=1,
        max_length=100,
...
class ContextShadeEnergyPropertiesAbridged(NoExtraBaseModel):
    type: Annotated[
        str, StringConstraints(pattern="^ContextShadeEnergyPropertiesAbridged$")
...
class ModelEnergyProperties(NoExtraBaseModel):
    ...
    construction_sets: List[Union[ConstructionSetAbridged, ConstructionSet]] | None = (
        Field(default=None, description="List of all ConstructionSets in the Model.")
    )
    ...
    hvacs: (
        ...
        | None
    ) = Field(default=None, description="List of all HVAC systems in the Model.")
    ...
    program_types: List[Union[ProgramTypeAbridged, ProgramType]] | None = Field(
        default=None, description="List of all ProgramTypes in the Model."
    )
